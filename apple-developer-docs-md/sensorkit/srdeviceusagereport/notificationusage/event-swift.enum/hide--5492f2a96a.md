---
title: "SRDeviceUsageReport.NotificationUsage.Event.hide | Apple Developer Documentation"
source_url: "https://developer.apple.com/documentation/sensorkit/srdeviceusagereport/notificationusage/event-swift.enum/hide"
section: "SensorKit"
scraped_at: "2026-05-11T03:53:40.062355+00:00"
---

[탐색 건너뛰기](https://developer.apple.com/documentation/sensorkit/srdeviceusagereport/notificationusage/event-swift.enum/hide#app-main)
...
hide event의 notification입니다.

iOS 14.0+iPadOS 14.0+Mac Catalyst 14.0+

    case hide

[같이 보기](https://developer.apple.com/documentation/sensorkit/srdeviceusagereport/notificationusage/event-swift.enum/hide#see-also)

-------------------------------------------------------------------------------------------------------------------------------------

### [Events](https://developer.apple.com/documentation/sensorkit/srdeviceusagereport/notificationusage/event-swift.enum/hide#Events)
...
banner pull down의 notification입니다.
...
deduped event의 notification입니다.
...
default action의 notification입니다.
...
device activation의 notification입니다.
...
device unlock의 notification입니다.
...
expiration event의 notification입니다.
...
clear-all event의 notification입니다.
...
received event의 notification입니다.
...
removed event의 notification입니다.
...
silence event의 notification입니다.
...
supplementary action의 notification입니다.
...
tap-coalesce event의 notification입니다.

현재 페이지: SRDeviceUsageReport.NotificationUsage.Event.hide
