---
title: "SRDeviceUsageReport.NotificationUsage.Event.expired | Apple Developer Documentation"
source_url: "https://developer.apple.com/documentation/sensorkit/srdeviceusagereport/notificationusage/event-swift.enum/expired"
section: "SensorKit"
scraped_at: "2026-05-11T03:53:40.062216+00:00"
---

[탐색 건너뛰기](https://developer.apple.com/documentation/sensorkit/srdeviceusagereport/notificationusage/event-swift.enum/expired#app-main)
...
만료 event에 대한 notification입니다.

iOS 14.0+iPadOS 14.0+Mac Catalyst 14.0+

    case expired

[같이 보기](https://developer.apple.com/documentation/sensorkit/srdeviceusagereport/notificationusage/event-swift.enum/expired#see-also)

----------------------------------------------------------------------------------------------------------------------------------------

### [event](https://developer.apple.com/documentation/sensorkit/srdeviceusagereport/notificationusage/event-swift.enum/expired#event)
...
현재 페이지는 SRDeviceUsageReport.NotificationUsage.Event.expired입니다
