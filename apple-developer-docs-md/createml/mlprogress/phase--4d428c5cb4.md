...
source_url: "https://developer.apple.com/documentation/createml/mlprogress/phase"
section: "Create ML"
scraped_at: "2026-05-11T03:53:40.160686+00:00"
---

[탐색 건너뛰기](https://developer.apple.com/documentation/createml/mlprogress/phase#app-main)
...
[같이 보기](https://developer.apple.com/documentation/createml/mlprogress/phase#see-also)

-----------------------------------------------------------------------------------------

### [session 진행 상황 확인](https://developer.apple.com/documentation/createml/mlprogress/phase#Inspecting-a-sessions-progress)

[`var elapsedTime: TimeInterval`](https://developer.apple.com/documentation/createml/mlprogress/elapsedtime)

training session이 시작된 이후 경과 시간(초)입니다.
...
training session의 training phase 또는 evaluation phase 동안 model 성능을 측정한 값입니다.

[`enum Metric`](https://developer.apple.com/documentation/createml/mlprogress/metric)

training session 동안 model 성능을 evaluation하는 데 사용하는 metric입니다.
