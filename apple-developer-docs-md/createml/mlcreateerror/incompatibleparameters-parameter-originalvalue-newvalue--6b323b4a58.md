---
title: "MLCreateError.incompatibleParameters(parameter:originalValue:newValue:) | Apple Developer Documentation"
source_url: "https://developer.apple.com/documentation/createml/mlcreateerror/incompatibleparameters(parameter:originalvalue:newvalue:)"
section: "Create ML"
scraped_at: "2026-05-11T03:53:40.151072+00:00"
---

[탐색 건너뛰기](https://developer.apple.com/documentation/createml/mlcreateerror/incompatibleparameters(parameter:originalvalue:newvalue:)#app-main)
...
[같이 보기](https://developer.apple.com/documentation/createml/mlcreateerror/incompatibleparameters(parameter:originalvalue:newvalue:)#see-also)

------------------------------------------------------------------------------------------------------------------------------------------------

### [error 식별하기](https://developer.apple.com/documentation/createml/mlcreateerror/incompatibleparameters(parameter:originalvalue:newvalue:)#Identifying-errors)
...
다른 error 항목으로 다루지 않는 failure를 나타내는 error입니다.
...
현재 페이지: MLCreateError.incompatibleParameters(parameter:originalValue:newValue:)
