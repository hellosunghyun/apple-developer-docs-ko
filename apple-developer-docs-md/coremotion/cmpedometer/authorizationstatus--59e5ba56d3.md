...
source_url: "https://developer.apple.com/documentation/coremotion/cmpedometer/authorizationstatus()"
section: "Core Motion"
scraped_at: "2026-05-11T03:53:39.908822+00:00"
---

[탐색 건너뛰기](https://developer.apple.com/documentation/coremotion/cmpedometer/authorizationstatus()#app-main)
...
app이 pedometer data를 수집하도록 권한을 받았는지 나타내는 값을 반환합니다.

iOS 11.0+iPadOS 11.0+Mac Catalyst 13.1+watchOS 4.0+

    class func authorizationStatus() -> CMAuthorizationStatus

[참고 항목](https://developer.apple.com/documentation/coremotion/cmpedometer/authorizationstatus()#see-also)

------------------------------------------------------------------------------------------------------------

### [Pedometer 사용 가능 여부 확인](https://developer.apple.com/documentation/coremotion/cmpedometer/authorizationstatus()#Determining-Pedometer-Availability)
