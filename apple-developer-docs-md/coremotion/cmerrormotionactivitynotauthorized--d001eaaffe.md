...
source_url: "https://developer.apple.com/documentation/coremotion/cmerrormotionactivitynotauthorized"
section: "Core Motion"
scraped_at: "2026-05-11T03:53:39.912788+00:00"
---

[탐색 건너뛰기](https://developer.apple.com/documentation/coremotion/cmerrormotionactivitynotauthorized#app-main)
...
app에 현재 motion activity support를 사용할 authorization이 없습니다.
...
[같이 보기](https://developer.apple.com/documentation/coremotion/cmerrormotionactivitynotauthorized#see-also)

-------------------------------------------------------------------------------------------------------------

### [Errors](https://developer.apple.com/documentation/coremotion/cmerrormotionactivitynotauthorized#Errors)

[`var CMErrorDeviceRequiresMovement: CMError`](https://developer.apple.com/documentation/coremotion/cmerrordevicerequiresmovement)

motion data를 sample하려면 device가 움직여야 합니다.

[`var CMErrorInvalidAction: CMError`](https://developer.apple.com/documentation/coremotion/cmerrorinvalidaction)

지정한 action이 유효하지 않습니다.

[`var CMErrorInvalidParameter: CMError`](https://developer.apple.com/documentation/coremotion/cmerrorinvalidparameter)

지정한 parameter가 유효하지 않습니다.
...
현재 페이지: CMErrorMotionActivityNotAuthorized
